...
-- Dumping data for table test_kyc.node_property: ~10 rows (approximately)
...
-- Dumping data for table test_kyc.node_user: ~7 rows (approximately)
INSERT INTO `node_user` (`id`, `firstname`, `lastname`, `email`, `password`, `contact_number`, `address`, `role`, `files`, `status`, `is_deleted`, `created_at`) VALUES
	...
	(27, 'Eve', 'Davis', 'eve@mail.com', '$2b$10$Dj/E9EhH82Tl0YmfuGebi.yC4H0tN/bGEjTA0Ucr5qlBd.iUn/FXm', 93248383, 'test', 'tenant', '["uploads\\\\1776840737093.png"]', 'active', 0, '2026-04-22'),
